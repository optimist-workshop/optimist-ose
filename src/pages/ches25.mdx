...
<table>
  ...
  <tbody>
    ...
    <tr style={{backgroundColor: '#fff9e6'}}>
      <td>9:45</td>
      <td><strong>Invited Talk:</strong> <br/><u><strong>Benedikt Gierlichs</strong></u>, KU Leuven, Belgium<br/> <span style={{color:'#092470'}}>***TBD***</span></td>
    </tr>
    <tr>
      <td>10:30</td>
    ...
    <tr>
      <td>12:15</td>
      <td><strong>Renita J</strong> (SETS India) and <strong>Suganya Annadurai</strong> (SETS India) <br/> <span style={{color:'#092470'}}>***Reflections on ISO/IEC 17825: Gaps in Commercial Frameworks and the Need for Standard APIs***</span></td>
    </tr>
    <tr>
      <td>12:30</td>

...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>9:00</td>
      <td><strong>Welcome Remarks</strong> <br/> <span style={{color:'#092470'}}><strong>Aydin Aysu</strong> (NCSU), <strong>Fatemeh Ganji</strong> (WPI), <strong>Patrick Schaumont</strong> (WPI) and <strong>Caner Tol</strong> (WPI)</span></td>
    </tr>
    <tr>
      <td>9:15</td>
      <td><u><strong>Debdeep Mukhopadhyay</strong></u> (Indian Institute of Technology Kharagpur) <br/> <span style={{color:'#092470'}}>***Side-Channel and Fault Attack Testing in the Age of AI***</span></td>
    </tr>
    <tr>
      <td>9:30</td>
      <td><strong>George Crane</strong> (University of New Hampshire) and <u><strong>Dean Sullivan</strong></u> (University of New Hampshire) <br/> <span style={{color:'#092470'}}>***On the Suitability of SCARR for Cross-Device Leakage Analysis***</span></td>
    </tr>
    ...
    <tr>
      <td>11:00</td>
      <td><strong>Spotlight on Artifacts  - Round 1</strong> <br/> <span style={{color:'#092470'}}> <ul><li><strong>Vincent Hwang</strong> (Max Planck Institute for Security and Privacy) – ***Artifact Packaging with the Absence of the Target Hardware in Mind***</li><li><strong>Nathan Rousselot</strong> (Thales, France) – ***Reproducibility in Deep-Learning based SCA***</li><li><strong>Aikata Aikata</strong> (Graz University of Technology) and <strong>Anup Kumar Kundu</strong> (Indian Statistical Institute) – ***Déjà Vu in Reproducibility of Differential Fault Attacks***</li><li><strong>Damien Marion</strong> (University of Rennes) and <strong>Alexandre Wallet</strong> (PQ Shield Ltd.) – ***Feedback on Building Reproducible Artifacts for End-to-end Side Channel Attack***</li></ul></span></td>
    </tr>

    <tr>
      <td>11:30</td>
      <td><u><strong>Florian Krieger</strong></u> (Graz University of Technology), <strong>Florian Hirner</strong> (Graz University of Technology), <strong>Ahmet Can Mert</strong> (Graz University of Technology) and <strong>Sujoy Sinha Roy</strong> (Graz University of Technology) <br/> <span style={{color:'#092470'}}>***OpenNTT: An Open-Source Tool for Generating NTT Hardware Accelerators***</span></td>
    </tr>
    <tr>
      <td>11:45</td>
      <td><strong>Jan Wichelmann</strong> (University of Luebeck) and <u><strong>Thomas Eisenbarth</strong></u> (University of Luebeck) <br/> <span style={{color:'#092470'}}>***Practical Side-Channel Leakage Analysis with Microwalk***</span></td>
    </tr>
    <tr>
      <td>12:00</td>
      <td><u><strong>Feng Zhou</strong></u> (University of Chinese Academy of Sciences), <strong>Hua Chen</strong> (Institute of Software, Chinese Academy of Sciences), <strong>Limin Fan</strong> (Institute of Software, Chinese Academy of Sciences), <strong>Yiming Yang</strong> (Beijing Institute of Technology) and <strong>An Wang</strong> (Beijing Institute of Technology) <br/> <span style={{color:'#092470'}}>***Efficient and Complete Security Verification in Probing Model***</span></td>
    </tr>
    <tr>
      <td>12:15</td>
      <td><u><strong>Renita J</strong></u> (Society for Electronic Transactions and Security, India) and <strong>Suganya Annadurai</strong> (Society for Electronic Transactions and Security, India) <br/> <span style={{color:'#092470'}}>***Reflections on ISO/IEC 17825: Gaps in Commercial Frameworks and the Need for Standard APIs***</span></td>
    </tr>
    <tr>
      <td>12:30</td>
    ...
    <tr style={{backgroundColor: '#fff9e6'}}>
      <td>16:00</td>
      <td>
        <strong>Panel on </strong> <span style={{color:'#092470'}}>***Successful Governance for Open-Source Ecosystems***</span> with
        ...
        <div style={{paddingLeft: '20px'}}>
          ...
          <strong>Marc Witteman</strong> (Keysight)
        </div>

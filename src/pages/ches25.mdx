    ...
    <tr style={{backgroundColor: '#fff9e6'}}>
      ...
      <td>
        ...
        <div style={{paddingLeft: '20px'}}>
          ...
          <strong>Francisco Rodríguez-Henríquez</strong> (Technology Innovation Institute),<br/>

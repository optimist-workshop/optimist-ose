...
<table>
  ...
  <tbody>
    ...
    <tr style={{backgroundColor: '#fff9e6'}}>
      <td>16:00</td>
      <td><strong>Panel with Michael Hutter</strong> (UniBw Munich), <strong>Francisco Rodríguez-Henríquez</strong> (TII), <strong>Peter Schwabe</strong> (MPI-SP) and **Marc Witteman** (Keysight) moderated by **Aydin Aysu** (NCSU) <br/> <span style={{color:'#092470'}}>***Successful Governance for Open-Source Ecosystems***</span></td>
    </tr>
    <tr>
      <td>17:30</td>

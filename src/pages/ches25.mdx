...
| Time  | Event                                                                                                                                                                            |
| :---- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 9:00  | **Welcome Remarks** <br/> <span style={{color:'#092470'}}>**Aydin Aysu, Fatemeh Ganji, Patrick Schaumont and Caner Tol**</span> |
...
| 10:15 | **George Crane and <u>Dean Sullivan</u>** <br/> <span style={{color:'#092470'}}>**On the Suitability of SCARR for Cross-Device Leakage Analysis**</span> |
| 10:30 | **Coffee Break** |
| 11:00 | **Session on Artifacts and Reproducibility - Session 1** <br/> <span style={{color:'#092470'}}> <ul><li>**Vincent Hwang – TBD**</li><li>**Nathan Rousselot – Deep Learning SCA reproducibility**</li><li>**Aikata, Aikata – TBD**</li><li>**Alexandre Wallet – TBD**</li></ul></span>|
...
| 11:45 | **<u>Debdeep Mukhopadhyay</u>** <br/> <span style={{color:'#092470'}}>**Side-Channel and Fault Attack Testing in the age of AI**</span> |
| 12:00 | **<u>Feng Zhou</u>, Hua Chen, Limin Fan, Yiming Yang and An Wang** <br/> <span style={{color:'#092470'}}>**Efficient and Complete Security Verification in Probing model**</span> |
| 12:15 | **Renita J and Suganya Annadurai** <br/> <span style={{color:'#092470'}}>**Reflections on ISO/IEC 17825: Gaps in Commercial Frameworks and the Need for Standard APIs**</span> |
| 12:30 | **Lunch Break** |
...
| 15:00 | **Session on Artifacts and Reproducibility - Session 2** <br/> <span style={{color:'#092470'}}> <ul><li>**Johann Knechtel - Community-Driven Benchmarking for Trojan Insertion versus Layout Defenses in Modern ICs**</li><li>**Aric Fowler - A Convenient Framework for Building Command Line Interfaces, Installables, and Documentation for Python3 Tools**</li><li>**Eric Peng - TBD**</li><li>**Eduardo Ochoa - TBD**</li><li>**Aritra Dasgupta - Developing open-source artifacts and EDA toolchain for HIPR: Hardware IP Redaction**</li></ul></span>|
| 15:30 | **Coffee Break** |
